  ...
  <div class="contain" ref="paging">
    ...
    <div class="main" ref="main">
      ...
      <div class="comment">
        <div class="bd">
          <div class="top">
            ...
            <div class="time">
              <span>{{articleinfo.ArticleCreateDate | dateFormat}}</span>
              <span class="read">阅读数:{{articleinfo.ClickCount}}</span>
            </div>
          </div>
            ...
            <div class="pic">
              <div class="left">
                ...
                <img
                  ...
                  alt
                />
                <span>{{articleinfo.UserName|usernameLength}}</span>
              </div>
              <div v-show="isguan==0" @click="guanzhu" class="right">
                <span>关注</span>
              </div>
              <div v-show="isguan==1">
                <span @click="del_guanzhu" class="right1">已关注</span>
              </div>
            </div>
            <p v-show="articleinfo.PersonalitySignature">{{articleinfo.PersonalitySignature}}</p>
            <div id="desa" class="des">
              <!-- <p v-html="articleinfo.ArticleContent">
      ...
      <div class="quanping" id="jump">
        <h3>全部{{allnum}}条评论</h3>
        <div class="firstping" v-for="(item,index) in pinglunlist" :key="index" ref="paging">
          <div class="title">
    ...
    <div style="z-index:12" v-show="showjvbao" class="jvbaokuangtwo" @click="showjvbao=false">取消</div>

    <!-- 展开剩余回复蒙层模块 -->
    <van-popup v-model="showgengduo" :closeable="true" position="bottom" :style="{ height: '75%' }">
      <div class="gengtop">
        <div class="gengtitle">
      ...
      <div class="gengmiddle">
        <div class="middleping" v-for="(item,index) in showgenglist.List" :key="index">
          <div class="middletitle">
            <!-- <img class="middletitle_tou" src="../../../assets/images/article_touxiang.jpg" alt /> -->
          ...
          <div v-show="item.IsMy" class="firstshan">
            <span @click="shanping2(item.Id,index)">
              <i class="iconfont icon-iconfontshanchu3"></i>删除
            </span>
          </div>
        </div>
    ...
    <div v-else class="bottom0">
      ...
      <img class="bottomthree" src="../../../assets/images/article_xiaoxi2.png" alt @click="tiaoa" />
...
export default {
  ...
  methods: {
    ...
    dianping(id, name, mainuserid, content, index) {
      ...
      this.$refs.paging[index].scrollTop = 0;
      this.$nextTick(() => {
        this.$refs.paging[index].scrollTop = 0;
      });
      // console.log(id)
      ...
      this.showjvbao = true;
      this.holder = "@" + this.articleinfo.UserName;
    },
    // 弹出框选回复
    xuanhuifu() {
      this.showjvbao = false;
