<template>
  <div>
    ...
    <div class="box">
       ...
       <div class="box_item">
         <p>支付宝账号</p>
         <input type="text"  v-model="account" placeholder="请输入您的支付宝账号" >
         <img v-show="same" @click="del" class="del" src="../../../assets/images/payment_del.png" alt="">
       </div>
    </div>
    <div class="bottom1" v-if="!same">确认修改</div>
    <div class="bottom2" v-else @click="tijiao">确认修改</div>
  </div>
</template>
