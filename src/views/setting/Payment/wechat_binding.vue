...
export default {
  ...
  methods:{
    del(){
       ...
       tijiao(){
        request.post(this.$api+'/mobile/UpdateIdWeChatId',{
             Str:this.account
        }).then(res=>{
             if(res.IsSuccess){
               this.$router.back()
